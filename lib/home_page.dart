...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Equipe Cusco Meetup'),
      ),
      body: ListView(
        children: <Widget>[
          ...
          const IconAndDetail(Icons.location_city, 'Novo Hamburgo'),
          Consumer<ApplicationState>(
            ...
            builder: (context, appState, _) => Column(
              ...
              children: [
                switch (appState.attendees) {
                  1 => const Paragraph('1 pessoa vai'),
                  >= 2 => Paragraph('${appState.attendees} pessoas vão'),
                  _ => const Paragraph('Ninguém vai'),
                },
